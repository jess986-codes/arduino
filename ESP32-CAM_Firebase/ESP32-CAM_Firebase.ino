...
const char* ssid = "TelstraB2C709";
const char* password = "w7fd75knuz";

//https://console.firebase.google.com/project/xxxxxxxxxx/settings/serviceaccounts/databasesecrets
String FIREBASE_HOST = "scanner-14b24-default-rtdb.firebaseio.com";
String FIREBASE_AUTH = "p04bQSakVmRPw02zrzBwzqS5DPPi0jGs5RteERUX";
